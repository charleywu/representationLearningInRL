...
However, performing the eigenvector decopompoisition can be computationally expensive for large graphs. Additionally, enumerating the entire statespace may be intractable. Can we approximate the eigenvectors of the Laplacian without directly having access to the Laplacian?
